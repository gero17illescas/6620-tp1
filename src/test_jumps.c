...
int main() {
   ...
   ant_result = move_forward(a, 3, 3);
    ...
    a->o = 2;
    ant_result = move_forward(a, 3, 3);
    printf("test_10: the result %i  should be: 2 \n", ant_result->x);

    a->x = 1;
    a->y = 1;
    a->o = 3;
    ant_result = move_forward(a, 3, 3);
    printf("test_11: the result %i  should be: 0 \n", ant_result->x);

    a->x = 0;
    a->y = 0;
    a->o = 0;
    ant_result = move_forward(a, 3, 3);
    printf("test_12: the result %u  should be: 2 \n", ant_result->y);
    ...
    a->o = 3;
    ant_result = move_forward(a, 3, 3);
    printf("test_15: the result %u  should be: 2 \n", ant_result->x);
